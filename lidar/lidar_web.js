...
var gss = require('./controllers/getsystemstatus');
var dir = require('./controllers/dir');
var clz = require('./controllers/createlidarzip');
var uzip = require('./controllers/unpackzip');
...
app.get('/', function(req, res){
    res.sendfile('mainpage.html' , {root: 'website'});
});
app.get('/getsystemstatus', gss.getsystemstatus);
app.get('/createlidarzip', clz.createlidarzip);
app.get('/unpackzip', uzip.unpackZip);
